with RandomFunctions, AsteroidPackage, Ada.Calendar, Ada.Numerics.Float_Random, Ada.Integer_Text_IO, Ada.Text_IO, Ada.Unchecked_Deallocation, GenericProtectedQueue;
...
procedure Boption is
   ...
   package AsteroidQueuePackage is new GenericProtectedQueue(Asteroid_Ptr,
      15);
   use AsteroidQueuePackage;
